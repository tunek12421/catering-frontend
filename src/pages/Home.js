...
const Home = () => {
  ...
  const defaultData = {
    ...
    heroDescription:
      "Imagina un evento donde cada detalle es perfecto. Nosotros lo hacemos realidad.",
    ...
    urgencyDescription:
      "Solo quedan 5 fechas disponibles para este mes. Reserva ahora y asegura tu evento perfecto.",
